				...
				<div class="mx-auto container p-5">
					<div class="flex items-center justify-between">
						<div class="flex-1 md:flex md:items-center md:gap-12">
							<a class="block" href="/">
								<img src="<?= esc_url(get_template_directory_uri()); ?>/assets/images/logo.png" class="object-cover md:w-60 w-40" />
							</a>
						</div>
						...
						<div class="md:flex md:items-center lg:gap-12 gap-5">
							...
							<div class="flex items-center gap-4">
								...
								<div class="block md:hidden">
									<button class="rounded text-gray-600 transition hover:text-gray-600/75">
