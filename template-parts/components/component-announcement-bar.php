<div class="bg-brand-blue lg:px-0 py-3 text-white">
	<div class="flex lg:flex-row flex-col lg:text-start text-center gap-y-2 justify-between container mx-auto">
		<p class="md:text-base text-sm font-medium ps-5">Get 20% Discounts! offer in 2 days</p>
		<div class="divide-x-2 inline-flex items-center justify-center">
			<a href="tel:+23561236456" class="md:text-base text-sm inline-flex items-center font-medium px-5 gap-2.5">
