...
<section class="mx-auto container pb-10 lg:pb-14 lg:mt-72">
	<div class="space-y-5">
		<h3 class="font-bold font-display text-center text-neutral-700 lg:text-xl text-sm lg:px-0 px-5">Trusted by the best</h3>
		<div class="flex gap-5 lg:gap-x-10 justify-between items-center">
	...
	<div class="grid grid-cols-1 gap-5 lg:grid-cols-4 lg:gap-10 lg:mt-24 mt-10 lg:px-0 px-5 items-start">
		<div class="grid justify-start items-center lg:space-y-5 space-y-2.5">
			<div class="space-y-5">
		...
		<div class="grid justify-start items-center lg:space-y-5 space-y-2.5">
			<div class="space-y-5">
				<div class="size-14 rounded bg-sky-300 flex items-center justify-center">
					<svg xmlns="http://www.w3.org/2000/svg" class="size-10 stroke-sky-600" viewBox="0 0 24 24" fill="none">
