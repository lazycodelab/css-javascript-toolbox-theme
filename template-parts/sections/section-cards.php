...
?>
<!--
<section class="relative mx-auto grid justify-center max-w-7xl pt-10 pb-10 lg:pb-14 px-4 2xl:px-0">
	<h2 class="lg:text-4xl text-center lg:max-w-4xl text-xl font-display leading-none">
		Our code blocks are simple and powerful - here's why:
	</h2>
	<ul class="lg:mt-5 lg:space-y-3 flex flex-col items-center">
