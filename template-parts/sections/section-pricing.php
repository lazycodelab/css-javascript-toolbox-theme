        ...
        <div class="grid grid-cols-1 md:grid-cols-2 sm:items-stretch lg:grid-cols-4 md:gap-5 rounded-lg bg-white md:mt-44 mt-5 md:mx-0 mx-5 md:border-none border border-black md:divide-y-0 divide-y-2">
            <div class="p-10 divide-gray-200 space-y-5">
                <div class="space-y-2.5 text-start">
                    <div class="space-y-5">
                        <h2>
                            <strong class="text-3xl font-medium text-gray-900 sm:text-4xl"> 20$ </strong>
                            <span class="text-sm font-medium text-gray-700">/month</span>
                        </h2>
                        <p class="text-3xl font-medium text-indigo-950">Intro</p>
                    </div>
                    <p class="text-gray-600">CJT PLUS premium WordPress plugin</p>
                </div>
            ...
            <div class="p-10 divide-gray-200 md:rounded-3xl rounded-lg md:shadow-[0px_40px_30px_0px] shadow-[0px_10px_30px_0px] md:shadow-brand-blue/25 shadow-brand-blue/25 relative lg:-top-28 bg-brand-blue space-y-5">
                ...
                <div class="space-y-2.5 text-start">
                    <div class="space-y-5">
                        <h2 class="text-white">
                            <strong class="text-3xl font-medium sm:text-4xl">50$</strong>
                            <span class="text-sm font-medium">/month</span>
                        </h2>
                        <p class="text-3xl font-medium text-white">Grand</p>
                    </div>
                    <p class="text-white">CJT PLUS premium WordPress plugin</p>
                </div>
                ...
                <ul class="space-y-2.5">
                    <?php for ($x = 0; $x <= 5; $x++) { ?>
                        <li class="flex items-center gap-2.5">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20C15.5228 20 20 15.5228 20 10C19.9936 4.47982 15.5202 0.00642897 10 0Z" fill="#FFFFFF1A" />
                                <path d="M15.7741 6.83362L10.07 14.5745C9.93392 14.7549 9.73107 14.8732 9.50698 14.9027C9.28289 14.9321 9.05636 14.8703 8.8783 14.7311L4.80496 11.4745C4.44552 11.1868 4.38731 10.6622 4.67496 10.3028C4.96261 9.94334 5.48718 9.88514 5.84663 10.1728L9.2433 12.8903L14.4325 5.84778C14.6026 5.59244 14.8993 5.45127 15.2048 5.48032C15.5103 5.50936 15.7751 5.70393 15.8941 5.98676C16.013 6.2696 15.967 6.59494 15.7741 6.83362Z" fill="#FFFFFF" />
                            </svg>

                            <span class="text-white">1 site install only</span>
                        </li>
                    <?php } ?>
                </ul>
                <button class="rounded-lg inline-flex px-6 text-xl font-semibold py-3.5 text-brand-blue bg-white">
                    Explore Plugins Now
                </button>
            </div>
            <div class="p-10 divide-gray-200 space-y-5">
