<section class="pt-28 pb-40 bg-brand-light-blue-2 relative">
    <div class="mx-auto container">
        <div class="swiper w-full h-full marqueeTestimomialSwiper">
            <div class="swiper-wrapper grid grid-cols-2 md:grid-cols-3 gap-6">
                <div class="swiper-slide">
                    <div class="bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow p-10 space-y-10 text-center">
                        <div class="space-y-2.5">
                            ...
                            <h3 class="text-xl font-semibold">Works great!</h3>
        ...
        <!-- <div class="grid grid-cols-2 md:grid-cols-4 gap-6" id="marqueeTestimomialSwiper">
