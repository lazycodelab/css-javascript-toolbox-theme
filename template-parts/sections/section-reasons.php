    ...
    <div class="mx-auto container space-y-10">
        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            <div class="w-full h-full relative">
                ...
                <div class="absolute right-0 top-1/4">
                    <img class="w-3/4 ml-auto" src="<?= esc_url(get_template_directory_uri()); ?>/assets/images/background/vector-1.png" />
                </div>
            </div>
            <div class="flex flex-col items-center justify-center space-y-5">
                <h2 class="font-display font-bold text-3xl">Benefits of CJT plus Work faster with powerful Plugin.</h2>
                <div class="inline-flex items-center gap-2.5">
                    ...
                    <span class="text-xl text-gray-600 font-normal">
        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <div class="w-full h-full relative">
                ...
                <div class="absolute right-0 top-1/4">
                    <img class="w-3/4 ml-auto" src="<?= esc_url(get_template_directory_uri()); ?>/assets/images/background/vector-2.png" />
                </div>
            </div>
        </div>
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <div class="w-full h-full relative">
                ...
                <div class="absolute right-0 top-1/3">
                    <img class="w-3/4 mx-auto" src="<?= esc_url(get_template_directory_uri()); ?>/assets/images/background/vector-2.png" />
                </div>
            </div>
        </div>
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
