<section class="relative bg-brand-light-blue md:py-24 pt-24 pb-10">
        ...
        <div class="text-center md:space-y-10 space-y-5 absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 container md:px-0 px-5">
            ...
            <div class="border bg-white border-neutral-900 rounded-lg p-10 relative overflow-hidden">
                ...
                <ol class="list-disc space-y-5">
                    ...
                    <li class="lg:text-xl text-base font-medium md:max-w-5xl text-center mx-auto text-neutral-600">
                        The same goes for uploading the CSS & JavaScript Toolbox PLUS plugin folder manually using FTP. Remember to upload the extracted folder and not the zip file. Please ensure that the folder is titled: css-javascript-toolbox-plus
                    </li>
                    <li class="lg:text-xl text-base font-medium md:max-w-5xl text-center mx-auto text-neutral-600">
                        If you require assistance such as; resending your license key or download links or assistance with installation, please email your question via our contact page here. We are here and more than happy to assist you. 🙂
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="pt-52 space-y-24 md:px-0 px-5">
        ...
        <div class="text-center space-y-5">
            ...
            <p class="md:text-xl text-base font-medium max-w-5xl text-center mx-auto text-neutral-900">
                These details will be sent in a separate email.
            </p>
        </div>
        <div class="text-center space-y-5">
    ...
    <?php get_template_part('template-parts/components/component', 'small-blob', ['class' => 'bg-green-300/50 rotate-6 left-[10%] top-3/4 animate-small-blob-2']); ?>
    <?php get_template_part('template-parts/components/component', 'small-blob', ['class' => 'bg-amber-300/50 rotate-6 right-[10%] top-[40%] animate-small-blob-3']); ?>
