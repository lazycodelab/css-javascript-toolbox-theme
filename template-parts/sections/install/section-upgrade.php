<section class="relative bg-white pt-24 pb-96">
    ...
    <div class="container mx-auto space-y-24">
        <div class="space-y-5 text-center">
            ...
            <p class="text-xl text-neutral-900 font-medium">CJT Free/Core and CJT PLUS must be running on the same version.</p>
        ...
        <div class="space-y-5 text-center relative">
            ...
            <p class="text-xl max-w-4xl mx-auto text-neutral-600">We would like to thank everyone who have supported us with a purchase of a CJT PLUS license. We are also immensely grateful for those who have continued to support us with a renewal of their licenses.</p>
            <p class="text-xl max-w-4xl mx-auto text-neutral-600">
