	...
	<div class="bg-brand-light-blue/60">
		<div class="mx-auto max-w-7xl md:pb-24 md:pt-0 py-10 md:space-y-10 space-y-5">
			...
			<div class="relative grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:px-0 px-5">
				...
				<!--<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="md:size-20 size-10 md:p-3 p-2 bg-purple-600 rounded" viewBox="0 0 52 44" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<h3 class="text-xl font-semibold text-gray-900 md:text-xl">Code Files</h3>
						<div class="bg-purple-600 w-16 h-2 rounded-2xl"></div>
						<p class="font-medium text-neutral-500 md:text-base text-sm">
							This feature enables users to organize and manage their custom code snippets efficiently. Users can create and save individual code files for different sections or functionalities of their website.
						</p>
					</div>
					<a href="#" class="group rounded text-sm inline-flex items-center font-semibold gap-x-2.5 text-brand-blue">
						Read More
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="md:size-20 size-10 md:p-3 p-2 bg-green-400 rounded" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M24.5495 33.925L39.1245 48.5C40.3745 49.71 42.05 50.3803 43.7897 50.3662C45.5294 50.352 47.1938 49.6547 48.424 48.4245C49.6542 47.1943 50.3515 45.5299 50.3657 43.7902C50.3798 42.0505 49.7095 40.375 48.4995 39.125L33.807 24.4325M24.5495 33.925L30.7895 26.35C31.582 25.39 32.6395 24.785 33.8095 24.435C35.1845 24.025 36.717 23.965 38.167 24.085C40.1216 24.2528 42.0861 23.9066 43.8655 23.0808C45.645 22.2549 47.1775 20.9781 48.3111 19.377C49.4447 17.7759 50.1399 15.9062 50.3278 13.9535C50.5156 12.0007 50.1896 10.0328 49.382 8.245L41.192 16.4375C39.8218 16.1207 38.568 15.4254 37.5736 14.4309C36.5791 13.4365 35.8839 12.1827 35.567 10.8125L43.757 2.6225C41.9692 1.81491 40.0013 1.48886 38.0485 1.67671C36.0958 1.86456 34.2261 2.55978 32.625 3.69337C31.0239 4.82697 29.7471 6.35953 28.9212 8.13899C28.0954 9.91845 27.7492 11.8829 27.917 13.8375C28.1445 16.5275 27.7395 19.4975 25.657 21.2125L25.402 21.425M24.5495 33.925L12.912 48.0575C12.348 48.745 11.6463 49.3068 10.852 49.7068C10.0577 50.1067 9.18853 50.3359 8.30033 50.3796C7.41214 50.4233 6.52463 50.2806 5.69493 49.9606C4.86523 49.6406 4.11173 49.1504 3.48292 48.5216C2.85411 47.8928 2.36393 47.1393 2.04392 46.3096C1.72391 45.4799 1.58117 44.5924 1.62489 43.7042C1.66861 42.816 1.89781 41.9468 2.29774 41.1525C2.69768 40.3582 3.25949 39.6565 3.947 39.0925L21.0395 25.0175L10.772 14.75H7.2495L1.6245 5.375L5.3745 1.625L14.7495 7.25V10.7725L25.3995 21.4225L21.037 25.015M41.937 41.9375L35.3745 35.375M8.167 43.8125H8.187V43.8325H8.167V43.8125Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
						</svg>
						<h3 class="text-xl font-semibold text-gray-900 md:text-xl">Code Blocks Tools</h3>
						<div class="bg-green-400 w-16 h-2 rounded-2xl"></div>
						<p class="font-medium text-neutral-500 md:text-base text-sm">
							This feature allows users to create, manage, and apply custom code snippets to their website. This tool will enable users to add CSS, JavaScript, HTML, and PHP code directly to their site without editing theme files or using additional plugins.
						</p>
					</div>
					<a href="#" class="group rounded text-sm inline-flex items-center font-semibold gap-x-2.5 text-brand-blue">
						Read More
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="md:size-20 size-10 md:p-4 p-2 bg-yellow-300 rounded" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M36.155 7.21812L40.3725 2.99812C41.2517 2.11893 42.4441 1.625 43.6875 1.625C44.9309 1.625 46.1233 2.11893 47.0025 2.99812C47.8817 3.87731 48.3756 5.06975 48.3756 6.31312C48.3756 7.55648 47.8817 8.74893 47.0025 9.62812L20.455 36.1756C19.1333 37.4965 17.5034 38.4674 15.7125 39.0006L9 41.0006L11 34.2881C11.5332 32.4972 12.5041 30.8673 13.825 29.5456L36.155 7.21812ZM36.155 7.21812L42.75 13.8131M39 31.0006V42.8756C39 44.3675 38.4074 45.7982 37.3525 46.8531C36.2976 47.908 34.8668 48.5006 33.375 48.5006H7.125C5.63316 48.5006 4.20242 47.908 3.14752 46.8531C2.09263 45.7982 1.5 44.3675 1.5 42.8756V16.6256C1.5 15.1338 2.09263 13.703 3.14752 12.6481C4.20242 11.5933 5.63316 11.0006 7.125 11.0006H19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
						</svg>
						<h3 class="text-xl font-semibold text-gray-900 md:text-xl">Editor Tools</h3>
						<div class="bg-yellow-300 w-16 h-2 rounded-2xl"></div>
						<p class="font-medium text-neutral-500 md:text-base text-sm">
							It gives users enhanced capabilities for customizing their website's design and functionality. It includes various tools and utilities designed to streamline adding and managing custom code snippets, such as CSS, JavaScript, HTML, and PHP.
						</p>
					</div>
					<a href="#" class="group rounded text-sm inline-flex items-center font-semibold gap-x-2.5 text-brand-blue">
						Read More
			...
			<div class="lg:flex hidden justify-center">
				<a class="inline-flex group gap-2.5 text-brand-blue py-3.5 font-bold lg:text-base text-sm" href="https://wordpress.org/plugins/css-javascript-toolbox/" target="_blank">
					...
					<p class="border-b-2 border-neutral-400 hover:border-neutral-900 transition-colors">
						Try CSS & JavaScript Toolbox for FREE
					</p>
				</a>
			</div>
		</div>
