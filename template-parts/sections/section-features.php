	...
	<div class="bg-brand-light-blue/60">
		<div class="mx-auto max-w-7xl md:pb-24 md:pt-0 py-10 md:space-y-10 space-y-5">
			...
			<div class="relative grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg viewBox="0 0 48 48" class="size-20 p-3 bg-pink-400 rounded" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="size-20 p-3 bg-cyan-400 rounded" viewBox="0 0 54 50" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="size-20 p-3 bg-purple-600 rounded" viewBox="0 0 52 44" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="size-20 p-3 bg-green-400 rounded" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="md:p-6 p-5 md:space-y-10 space-y-5 bg-white rounded shadow-md">
					<div class="md:space-y-5 space-y-2.5">
						<svg class="size-20 p-4 bg-yellow-300 rounded" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
