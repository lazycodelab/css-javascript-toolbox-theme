...
<section class="relative">
	...
	<div class="bg-brand-light-blue/60">
		<div class="mx-auto max-w-7xl md:pb-24 md:pt-0 py-10 md:space-y-10 space-y-5">
			...
			<div class="relative grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 md:px-0 px-5">
			...
			<div class="lg:flex hidden justify-center">
				<a class="inline-flex border-b-2 gap-2.5 border-black text-brand-blue py-3.5 font-bold uppercase lg:text-base text-sm" href="<?= home_url(); ?>/pricing">
