...
<section class="relative">
    ...
    <div class="bg-brand-light-blue/60">
        <div class="mx-auto container md:pb-24 pb-10 md:pt-0 pt-10">
            ...
            <div class="relative grid gap-5 lg:block lg:my-32 my-10 px-5 text-center">
                <div class="col-span-2">
                    <img class="mx-auto" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/vector/features.svg" />
                </div>
                <div class="lg:absolute top-0 left-0 col-span-2">
                    <div class="md:py-2.5 md:px-5 p-2 bg-white inline-flex gap-2.5 items-center rounded-lg shadow-lg">
                        <p class="font-semibold lg:text-xl text-sm">Global Code Blocks</p>
                ...
                <div class="lg:absolute top-1/2 left-0 col-span-2">
                    <div class="md:py-2.5 md:px-5 p-2 bg-white inline-flex gap-2.5 items-center rounded-lg shadow-lg">
                        <p class="font-semibold lg:text-xl text-sm">Code Files</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="md:size-14 size-10">
                ...
                <div class="lg:absolute top-full left-24 col-span-2">
                    <div class="md:py-2.5 md:px-5 p-2 bg-white inline-flex gap-2.5 items-center rounded-lg shadow-lg">
                        <p class="font-semibold lg:text-xl text-sm">Editor Tools</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="md:size-14 size-10">
