...
<footer>
	<div class="mx-auto max-w-7xl space-y-8 px-5 pb-5 sm:px-6 lg:space-y-24 relative">
		...
		<div class="grid grid-cols-1 md:gap-10 gap-5 lg:grid-cols-3">
			<div class="space-y-5">
				<img src="<?= esc_url(get_template_directory_uri()); ?>/assets/images/logo.svg" />

				<ul class="md:flex hidden gap-3">
					<li class="rounded-full border p-1.5">
						<a href="#" rel="noreferrer" target="_blank" class="text-black transition hover:opacity-75">
			...
			<div class="grid gap-5 grid-cols-2 lg:col-span-2 lg:grid-cols-4">
				...
				<div class="md:space-y-5 space-y-2.5 md:hidden block">
					<p class="text-brand-blue font-bold uppercase text-sm">Social</p>

					<ul class="grid grid-cols-2 gap-2.5 w-fit">
						<li class="rounded-full border p-1.5">
							<a href="#" rel="noreferrer" target="_blank" class="text-black transition hover:opacity-75">
								<span class="sr-only">Facebook</span>
		...
		<div class="mt-10 border-t border-gray-100 pt-5">
			<p class="text-xs text-center text-gray-500">&copy; <?= date('Y'); ?>. CSS & JavaScript Toolbox. All rights reserved.</p>
		</div>
</footer>
